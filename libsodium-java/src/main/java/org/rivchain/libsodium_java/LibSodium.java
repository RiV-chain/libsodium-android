...
import org.rivchain.libsodium_java.interfaces.Base;
...
import org.rivchain.libsodium_java.interfaces.Helpers;
...
import org.rivchain.libsodium_java.interfaces.Padding;
import org.rivchain.libsodium_java.interfaces.PwHash;
import org.rivchain.libsodium_java.interfaces.Random;
import org.rivchain.libsodium_java.interfaces.Ristretto255;
import org.rivchain.libsodium_java.interfaces.Ristretto255.Checker;
...
import org.rivchain.libsodium_java.interfaces.SecureMemory;
import org.rivchain.libsodium_java.interfaces.ShortHash;
...
public abstract class LibSodium implements
        Base,
        Random,
    ...
    public LibSodium(Charset charset) {
        this(charset, new HexMessageEncoder());
    }

    public LibSodium(MessageEncoder messageEncoder) {
        this(StandardCharsets.UTF_8, messageEncoder);
    }

    public LibSodium(Charset charset, MessageEncoder messageEncoder) {
    ...
    /**
     * Encodes the given bytes, using this {@link LibSodium}'s associated
     * {@link MessageEncoder}.
     *
    ...
    /**
     * Decodes the given string to bytes, using this {@link LibSodium}'s associated
     * {@link MessageEncoder}.
     *
