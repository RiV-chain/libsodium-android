...
public class LibSodiumJava extends LibSodium implements
        Scrypt.Native, Scrypt.Lazy,
        StreamJava.Native, StreamJava.Lazy {

    private final SodiumJava sodium;

    public LibSodiumJava(SodiumJava sodium) {
        super();
        this.sodium = sodium;
    }

    public LibSodiumJava(SodiumJava sodium, Charset charset) {
        super(charset);
        this.sodium = sodium;
    }

    public LibSodiumJava(SodiumJava sodium, MessageEncoder messageEncoder) {
        super(messageEncoder);
        this.sodium = sodium;
    }

    public LibSodiumJava(SodiumJava sodium, Charset charset, MessageEncoder messageEncoder) {
