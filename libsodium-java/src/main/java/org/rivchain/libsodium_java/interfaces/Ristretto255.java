...
public interface Ristretto255 {
    ...
    final class RistrettoPoint {
        ...
        private final LibSodium ls;
        private final byte[] repr;

        private RistrettoPoint(LibSodium ls, byte[] repr) {
        ...
        private RistrettoPoint(LibSodium ls, String encoded) {
        ...
        /**
         * Encodes the point using the {@link LibSodium}'s associated {@link MessageEncoder}.
         ...
         *
         * @param ls the {@link LibSodium} instance
         * @return the identity element of Ristretto255
         */
        public static RistrettoPoint zero(LibSodium ls) {
         ...
         */
        public static RistrettoPoint random(LibSodium ls) {
         ...
         */
        public static RistrettoPoint base(LibSodium ls) throws SodiumException {
         ...
         */
        public static RistrettoPoint fromHex(LibSodium ls, String hex) {
            return new RistrettoPoint(ls, ls.toBinary(hex));
        }

        /**
         * Creates a new {@link RistrettoPoint} from the encoded representation, using the
         * {@link LibSodium}'s associated {@link MessageEncoder}. The decoded bytes must be a valid
         * canonical encoding.
         *
         * @param ls the {@link LibSodium} instance
         ...
         * @return the corresponding {@link RistrettoPoint}
         */
        public static RistrettoPoint fromString(LibSodium ls, String encoded) {
         ...
         * @return the corresponding {@link RistrettoPoint}
         */
        public static RistrettoPoint fromBytes(LibSodium ls, byte[] bytes) {
            return new RistrettoPoint(ls, bytes);
        }

        /**
         * Maps the encoded input to a {@link RistrettoPoint}, using the {@link LibSodium}'s
         ...
         */
        public static RistrettoPoint hashToPoint(LibSodium ls, String encodedInput)
            throws SodiumException {
         ...
         * @throws SodiumException if the mapping failed
         */
        public static RistrettoPoint hashToPoint(LibSodium ls, byte[] input)
            throws SodiumException {
